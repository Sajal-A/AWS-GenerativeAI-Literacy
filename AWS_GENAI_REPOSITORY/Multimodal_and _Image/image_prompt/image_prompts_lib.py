...
## Add the request body builder function
# This function prepares the request payload for submission to Amazon Bedrock
...
# This function extracts the image data from the returned payload and converts it to format that streamlit can use
def get_response_image(response):
    ...
    # Return the BytesIO object for easy handling
    return BytesIO(image_data)

# Add this function to call Amazon Bedrock
