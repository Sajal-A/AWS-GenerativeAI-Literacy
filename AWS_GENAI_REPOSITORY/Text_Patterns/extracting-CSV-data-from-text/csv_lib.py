...
## Add a function to create the tool definitions we will use to define the format for the generated JSON (and ultimately the CSV file).
def get_tools():
    tools = [
        {
            "toolSpec": {
...
## Add the function to call Amazon Bedrock
