...
#Add the function to retrieve results from the vector store.
...
# Add a function to create the tool definitions we will use to define the format for the generated JSON
...
# Add a function to convert ChatMessages to the Converse API format.
...
# Add a function to handle any tool use requests.
